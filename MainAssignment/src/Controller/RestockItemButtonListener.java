...
public class RestockItemButtonListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if(FormManager.getInstance().getAdminForm().getStockList().getSelectedIndex() != -1){
            ...
            itemToChange.setAmountInStock(itemToChange.getAmountInStock() + 10);
            changesMade = true;
            ...
            FormManager.getInstance().getAdminForm().getStateLabel().setText("No item selected");
        }


        if(changesMade){
            FormManager.getInstance().getAdminForm().getStateLabel().setText("Item successfully restocked");
